        ...
        <div>
          ...
          <div className='home_member'>
            ...
            <div className='flex non_flex'>
              <div className='top_info'>
                <a href={'/members'}><img style={{width: '100%',height: 'auto'}} src={logo}/></a>
              </div>
              <div　className='top_info'>
          ...
          <div className='home_member'>
            ...
            <div className='flex reverse non_flex'>
              <img className='top_info' style={{width: '100%',height: 'auto'}} src={soccer}/>
              <div　className='top_info'>
          ...
          <div className='home_member'>
            ...
            <div className='flex non_flex'>
              <img　className='top_info' style={{width: '100%',height: 'auto'}} src={undo}/>
              <div　className='top_info'>
